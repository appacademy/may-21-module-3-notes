...
> Hint: You can refer to the readings or [A Complete Guide to Flexbox][2] as needed.

## Phase 0: Starter

Begin by downloading the [practice starter][starter]. Then drag the
__index.html__ file into your browser (e.g. Chrome) to load the webpage, or use
the **File Explorer** to open the __index.html__ in your browser.

> Remember to save the CSS file then refresh the webpage in the browser to view
...
[starter]: https://github.com/appacademy-starters/practice-css-flexbox
