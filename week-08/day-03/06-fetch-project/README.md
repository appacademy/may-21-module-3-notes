...
project assigned a few days prior.
...
is not the same URL of the request, which probably means a redirection occured.
...
print the URL or location of the redirection.
...
[server]: https://github.com/appacademy-starters/project-http-basics
